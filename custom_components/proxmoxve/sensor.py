...
PROXMOX_SENSOR_GUEST_PRESSURE: Final[tuple[ProxmoxSensorEntityDescription, ...]] = (
    ProxmoxSensorEntityDescription(
        key="pressure_cpu_some",
        name="CPU pressure",
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        translation_key="pressure_cpu_some",
    ),
    ProxmoxSensorEntityDescription(
        key="pressure_cpu_full",
        name="CPU pressure stalled",
        icon="mdi:speedometer-slow",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        translation_key="pressure_cpu_full",
    ),
    ProxmoxSensorEntityDescription(
        key="pressure_io_some",
        name="IO pressure",
        icon="mdi:harddisk",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        translation_key="pressure_io_some",
    ),
    ProxmoxSensorEntityDescription(
        key="pressure_io_full",
        name="IO pressure stalled",
        icon="mdi:harddisk",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        translation_key="pressure_io_full",
    ),
    ProxmoxSensorEntityDescription(
        key="pressure_memory_some",
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        translation_key="pressure_memory_some",
    ),
    ProxmoxSensorEntityDescription(
        key="pressure_memory_full",
        name="Memory pressure stalled",
        icon="mdi:memory",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        translation_key="pressure_memory_full",
    ),
)
